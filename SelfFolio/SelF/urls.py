...
urlpatterns = [
    ...
    url('addReminder/', views.addReminder, name='addReminder'),
    url('editReminder/', views.editReminder, name='editReminder'),
    url('deleteReminder', views.deleteReminder, name='deleteReminder'),
]
